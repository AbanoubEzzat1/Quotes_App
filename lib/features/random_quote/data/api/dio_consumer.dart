...
import 'package:quotes/features/random_quote/data/api/end_points.dart';
import 'package:quotes/features/random_quote/data/api/status_code.dart';
...
class DioConsumer implements ApiConsumer {
  ...
  DioConsumer({required this.client}) {
    ...
    client.options
      ...
      ..responseType =
          ResponseType.plain //Transform the response data to a String encoded
